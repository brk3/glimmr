...
public class AddItemToGroupTask
        implements Task<IAddItemToGroupListener> {
    ...
    @Override
    public void execute(final IAddItemToGroupListener listener) {
        if (Constants.DEBUG) {
     ...
     */
    private void postToMainThread(final IAddItemToGroupListener listener,
